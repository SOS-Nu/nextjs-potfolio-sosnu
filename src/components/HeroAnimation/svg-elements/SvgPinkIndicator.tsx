...
import styles from "./SvgPinkIndicator.module.scss";

interface Props {
  active: boolean;
}

const SvgPinkIndicator: React.FC<Props> = ({ active = false }) => {
  return (
    <>
      <svg
        width="141"
        ...
        className={`${styles["pink-indicator"]} ${
      ...
      >
        ...
        <g filter="url(#filter2_f_1_8)">
          <path
            d="M123.152 23.9976C123.152 24.6556 122.619 25.1889 121.961 25.1889L117.196 25.1889C116.538 25.1889 116.004 24.6556 116.004 23.9976V19.2323C116.004 18.5743 116.538 18.041 117.196 18.041L121.961 18.041C122.619 18.041 123.152 18.5743 123.152 19.2323V23.9976Z"
            fill="#BD34FE"
          />
          <path
            d="M113.622 23.9976C113.622 24.6556 113.088 25.1889 112.43 25.1889L107.665 25.1889C107.007 25.1889 106.474 24.6556 106.474 23.9976V19.2323C106.474 18.5743 107.007 18.041 107.665 18.041L112.43 18.041C113.088 18.041 113.622 18.5743 113.622 19.2323V23.9976Z"
            fill="#BD34FE"
          />
          <path
            d="M113.622 34.3228C113.622 34.9808 113.088 35.5142 112.43 35.5142L107.665 35.5142C107.007 35.5142 106.474 34.9808 106.474 34.3228V29.5575C106.474 28.8996 107.007 28.3662 107.665 28.3662L112.43 28.3662C113.088 28.3662 113.622 28.8996 113.622 29.5575V34.3228Z"
            fill="#BD34FE"
          />
        </g>

        {/* v-show chuyển sang style display */}
        <rect
          x="110.513"
          y="22.439"
          width="9.23333"
      ...
      <div
        className={`${styles["pink-glow"]} ${active ? styles["active"] : ""}`}
      />
    </>
  );
};
